...
// TODO Low-level API for other extensions

// struct ZN_FastNoise2_C {
// 	uint32_t version;

// 	void (*generate_series_2d_f32)(void *self, const unsigned int count, const float *x, const float *y, float *out);

// 	void (*generate_series_3d_f32)(
// 			void *self,
...
class FastNoise2 : public godot::Resource {
	GDCLASS(FastNoise2, godot::Resource)
public:
	...
	static godot::String get_simd_level_name(SIMDLevel level);
	...
	void set_encoded_node_tree(godot::String data);
	godot::String get_encoded_node_tree() const;
	...
	float get_noise_2d_single(godot::Vector2 pos) const;
	float get_noise_3d_single(godot::Vector3 pos) const;
...
private:
	...
	godot::String _b_get_simd_level_name(SIMDLevel level);
	...
	godot::String _last_set_encoded_node_tree;
